...
def build_revision_plan(
    revision_result: dict, revision_preferences: dict = None
) -> dict:
    ...
    targeted_instructions = {
        dim: revision_preferences.get(dim)
        or dimension_instructions.get(dim, "Rewrite this dimension from scratch.")
