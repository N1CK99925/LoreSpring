export const Features = () => (
  <div className="max-w-[1400px] mx-auto px-12 pb-24 relative z-10">
    <div className="mb-14 reveal">
      <h2 className="font-serif text-[clamp(32px,3.5vw,48px)] font-bold text-text-primary">
    ...
    <div className="grid grid-cols-2 gap-5">
      <div className="col-span-2 grid grid-cols-[auto_1fr] gap-8 items-center bg-surface-muted border border-emerald-700/15 rounded-xl p-10 transition-all duration-[350ms] reveal relative overflow-hidden group">
        ...
        <img src="/lorespring-assets/Emerald crystal tree of light.png" alt="Crystal Tree" className="w-[100px] h-[100px] object-contain" />
        <div>
      ...
      {[
        ...
        <div key={f.title} className={`bg-surface-card border border-border-subtle rounded-xl p-10 transition-all duration-[350ms] reveal reveal-delay-${f.delay} relative overflow-hidden group`}>
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-linear-to-r from-transparent via-emerald-500 to-transparent opacity-0 transition-opacity duration-[350ms] group-hover:opacity-100" />
