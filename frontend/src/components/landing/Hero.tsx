...
export const Hero = ({ onNavigate }: HeroProps) => (
  <div className="grid grid-cols-2 gap-16 items-center px-12 py-[72px] pb-24 max-w-[1400px] mx-auto relative z-10">
    <div className="max-w-[600px]">
      ...
      <h1 className="font-serif text-[clamp(52px,6vw,88px)] font-bold leading-[1.02] text-text-primary mb-7 tracking-[-0.02em] hero-enter hero-enter-delay-1">
      ...
      <p className="text-lg leading-7 text-text-secondary max-w-[480px] mb-10 hero-enter hero-enter-delay-2">
      ...
      <div className="flex gap-4 items-center hero-enter hero-enter-delay-3">
        ...
        <button className="bg-transparent text-text-secondary border-[1.5px] border-black/12 px-9 py-4 rounded-md text-[15px] font-medium cursor-pointer transition-all duration-250 hover:border-emerald-600 hover:text-emerald-700 hover:-translate-y-0.5"
    ...
    <div className="relative flex items-center justify-center">
      <div className="relative w-full max-w-[520px]">
        ...
        <img src="/lorespring-assets/image.png" alt=""
          className="absolute -top-8 -right-8 w-40 h-40 object-contain opacity-60 z-[1] anim-drift" />
        <img src="/lorespring-assets/LoreSpring-leaves.png" alt=""
          className="absolute -bottom-5 -left-5 w-[100px] h-[100px] object-contain opacity-50 z-[1] anim-drift-delayed" />
      </div>
    </div>
  </div>
)
