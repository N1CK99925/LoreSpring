...
export const CtaSection = ({ onNavigate }: CtaSectionProps) => (
  <div className="relative z-10 px-12 pb-30">
    <div className="max-w-[900px] mx-auto text-center py-20 px-12 border-2 border-emerald-700/12 rounded-lg relative overflow-hidden bg-surface-card transition-all duration-[400ms] ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-emerald-700/30 hover:shadow-[0_20px_60px_rgba(5,150,105,0.08)] reveal">
      ...
      <img src="/lorespring-assets/LoreSpring-border.png" alt=""
        className="absolute -bottom-2.5 -left-2.5 w-[120px] h-[120px] object-contain opacity-20 transition-opacity duration-[400ms] hover:opacity-[0.35]" />
      <img src="/lorespring-assets/LoreSpring-border.png" alt=""
        className="absolute -top-2.5 -right-2.5 w-[120px] h-[120px] object-contain opacity-20 rotate-180 transition-opacity duration-[400ms] hover:opacity-[0.35]" />
